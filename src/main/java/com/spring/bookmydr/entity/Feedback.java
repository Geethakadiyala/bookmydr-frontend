...
public class Feedback {
	...
	@NotNull(message="Your rating should be in 1 to S")
	@Min(value=1,message="Your rating should be in 1 to S")
	@Max(value=5,message="Your rating should be in 1 to S")
	private int rating;
	@OneToOne
	...
	public String toString() {
		return "Feedback [feedbackId=" + feedbackId + ", rating=" + rating + ", patient=" + patient + ", doctor="
				+ doctor + ", feedbackComment=" + feedbackComment + "]";
	}
