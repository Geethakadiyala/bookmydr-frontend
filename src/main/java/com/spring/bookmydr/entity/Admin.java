...
public class Admin {
	...
	private int adminId;
	@NotNull(message="Admin name connot be null")
	@Length(min=4,message="Give Proper name")
    private String adminName;
	@NotNull(message="Enter Your Phone Number")
	@Pattern(regexp="[0-9]{10}",message= "should contains 10 digits")
...
@Pattern(regexp="[A-Za-z0-9@$*#!]{6,}",message="Your Password should contain ,ain 6 characters")
